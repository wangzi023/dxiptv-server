...
本项目基于 GNU Affero General Public License v3.0 进行开源发布，详情见 [LICENSE](LICENSE)。

您可以在符合 AGPL 条款的前提下自由使用、修改和分发本项目的源代码；如果您通过网络向用户提供了本项目的修改版本或部署实例，则需要向该实例的用户公开对应的源代码。
